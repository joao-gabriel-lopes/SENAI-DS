...
namespace ApiControleEstoque.Controllers
{
    ...
    public class ProdutoController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<GetPesquisaProdutoRequest>>> GetProduto()
        {
            ...
            .Include(prod => prod.CategoriaProduto)
            .Include(prod => prod.UnidadeMedida)
            .Select(prod => new GetPesquisaProdutoRequest
            {
                Id = prod.Id,
                CategoriaNome = prod.CategoriaProduto != null ? prod.CategoriaProduto.Nome : "",
        ...
        [HttpGet("filtrados")]
        public async Task<ActionResult<IEnumerable<GetPesquisaProdutoRequest>>> GetProdutosFiltrados([FromQuery] GetListaProdutoRequest request)
        {
