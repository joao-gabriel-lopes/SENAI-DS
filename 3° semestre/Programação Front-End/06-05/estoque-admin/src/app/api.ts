...
export async function ListarCategorias(): Promise<ICategoria[]> {
    try {
        const response = await fetch('http://apiestoque.runasp.net/api/CategoriaProduto');
...
export async function ListarCategoriaPorId(id: string): Promise<ICategoria> {
    try {
        const response = await fetch(`http://apiestoque.runasp.net/api/CategoriaProduto/${id}`);
...
export async function ListarUnidadesMedida(): Promise<IUnidadeMedida[]> {
    try {
        const response = await fetch('http://apiestoque.runasp.net/api/UnidadeMedida');
...
export async function ListarUnidadesMedidaPorId(id: string): Promise<IUnidadeMedida> {
    try {
        const response = await fetch(`http://apiestoque.runasp.net/api/UnidadeMedida/${id}`);
...
export async function ListarProdutos(): Promise<IProduto[]> {
    try {
        const response = await fetch('http://apiestoque.runasp.net/api/Produto');
...
export async function ListarProdutosPorId(id: string): Promise<IProduto> {
    try {
        const response = await fetch(`http://apiestoque.runasp.net/api/Produto/${id}`);
...
export async function ListarProdutosFiltrados(filtro: IFiltro): Promise<IProduto[]> {
    try {
        ...
        const response = await fetch(`http://apiestoque.runasp.net/api/Produto/filtrados?${params.toString()}`);
