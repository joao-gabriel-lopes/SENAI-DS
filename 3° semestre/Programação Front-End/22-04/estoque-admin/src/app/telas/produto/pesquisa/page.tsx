  ...
  return (
    <>
      ...
      <section className={cardStyles.containerCardProduto}>
        ...
        <div onClick={() => router.push("/telas/produto/cadastro")} className={cardStyles.cardProdutoTitulo}>
        ...
        <div onClick={() => router.push("/telas/produto/cadastro")} className={cardStyles.cardProduto}>
