...
class Remedio extends ItemEstoque
{
    ...
    public function __construct($id, $nome, $descricao, $quantidade, $fornecedor, $dataFabricacao, $dataValidade, $principioAtivo, $formaDeAplicacao, $categoria, $classificacao, $exigeControleRigoroso)
    {
        Parent::__construct($id, $nome, $descricao, $quantidade, $fornecedor, $dataFabricacao, $dataValidade);
