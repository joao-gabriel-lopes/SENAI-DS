...
class Vacina extends ItemEstoque
{
    ...
    public function __construct($id, $nome, $descricao, $quantidade, $fornecedor, $dataFabricacao, $dataValidade, $doencaAlvo, $tipoAgenteImunizante, $umidadeDeConservacao, $temperaturaDeConservacao)
    {
